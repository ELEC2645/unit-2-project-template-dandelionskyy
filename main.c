...
void run_engineering_calculations() {
    ...
    switch (calculation_selection) {
        case 1: 
        {
            ...
            printf("Resistance R1 (Ohms): "); 
            scanf("%lf", &resistance1);
            printf("Resistance R2 (Ohms): "); 
            scanf("%lf", &resistance2);
            printf("Resistance R3 (Ohms): "); 
        ...
        case 3: 
        {
            ...
            printf("Input source voltage (V): "); 
            scanf("%lf", &input_voltage);
            printf("Input resistance R1 (Ohms): "); 
            scanf("%lf", &resistance1);
            printf("Input resistance R2 (Ohms): "); 
            scanf("%lf", &resistance2);
            getchar(); 
        ...
        case 4: {
            ...
            printf("Input resistance value (Ohms): "); 
            scanf("%lf", &resistance);
            printf("Input capacitance value (F): "); 
...
static int acquire_user_selection(void)
{
    /* Options 1-5 are features, 6 is Exit */
    enum { TOTAL_MENU_CHOICES = 6 };   
    char input_line[200];
